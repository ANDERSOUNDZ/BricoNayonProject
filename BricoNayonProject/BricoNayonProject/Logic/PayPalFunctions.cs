...
public class NVPAPICaller
{
    ...
    public string APIUsername = "sb-479p8319621426_api1.business.example.com";
    private string APIPassword = "SQXVMDKN4DZS9976";
    private string APISignature = "ANhQmkzbhzX8LlDMjKVKPG3LJCdaA9vLPRdZiCYX7z-8zxyqFGsmLv0G";
    ...
    public bool ShortcutExpressCheckout(string amt, ref string token, ref string retMsg)
    {
        ...
        encoder["BRANDNAME"] = "BricoNayonProject Sample Application";
        ...
        using (BricoNayonProject.Logic.ShoppingCartActions myCartOrders = new BricoNayonProject.Logic.ShoppingCartActions())
        {
